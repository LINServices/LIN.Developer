...
{
    public partial class LangsIA
    {
        public const string RetrainFilePath =  @"D:\DataIA\Langs\langv3.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col1",outputColumnName:@"col1")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.9209466F,L2Regularization=29.80616F,LabelColumnName=@"col0",FeatureColumnName=@"Features"}))      
